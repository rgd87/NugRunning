...
Spell( 589 ,{ name = "Shadow Word: Pain", short = "", tick = 3, tickshine = true, overlay = { "tick", "end", 0.3}, duration = 18, ghost = true, nameplates = true, priority = 9, color = colors.PURPLE })
...
Spell( 34914 ,{ name = "Vampiric Touch", short = "", tick = 3, tickshine = true, overlay = { "tick", "end", 0.3}, ghost = true, nameplates = true,  priority = 10, duration = 15, color = colors.RED })
