...
EventTimer({ spellID = 26573 , event = "SPELL_CAST_SUCCESS", specmask = 0x0FF, name = "Consecration", duration = 11, color = colors.PINKIERED, overlay = {0,"gcd",.3}, priority = 9, scale = 0.85, ghost = true, fixedlen = normalized_length })
