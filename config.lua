...
-- DEBUFFS
AddSpell( 589 ,{ name = "Shadow Word: Pain",duration = 18, color = colors.PURPLE, refreshed = true, short = "SW:Pain" })
AddSpell( 34914 ,{ name = "Vampiric Touch", recast_mark = 1.5, duration = 15, color = colors.RED, short = "VampTouch", hasted = true })
